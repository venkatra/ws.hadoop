#!/bin/bash
#
# This script is related to driver code : ca.effpro.learn.hadoop.mr.tpt.exer1.YearlyAmountCollectedToInfractionDriver
# 
...
MAIN_CLASS=ca.effpro.learn.hadoop.mr.tpt.exer1.YearlyAmountCollectedToInfractionDriver
INPUT_PATH=/user/it1/data/input/seq/tpt/part*
OUTPUT_DIR=/user/it1/data/input/tpt/exer1
...
#
CMD_OPTIONS='-D mapred.reduce.tasks=2'
